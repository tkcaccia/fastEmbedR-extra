...
#SBATCH --job-name="feR_KODAMA_flow18_cuda"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/fastEmbedR_KODAMA_flow18_cuda_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/fastEmbedR_KODAMA_flow18_cuda_%j.err

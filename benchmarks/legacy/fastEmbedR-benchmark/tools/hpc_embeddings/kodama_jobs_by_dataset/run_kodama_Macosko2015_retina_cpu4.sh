...
#SBATCH --job-name="feR_KODAMA_Macosko2015_retina_cpu4"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/fastEmbedR_KODAMA_Macosko2015_retina_cpu4_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/fastEmbedR_KODAMA_Macosko2015_retina_cpu4_%j.err

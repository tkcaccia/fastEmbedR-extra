...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/fastEmbedR_COIL20_landmark_cpu1_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/fastEmbedR_COIL20_landmark_cpu1_%j.err

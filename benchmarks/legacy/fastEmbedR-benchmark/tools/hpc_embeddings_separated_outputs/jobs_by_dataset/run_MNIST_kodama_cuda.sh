...
#SBATCH --job-name="feR_kod_MNIST_cuda"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/fastEmbedR_MNIST_kodama_cuda_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/fastEmbedR_MNIST_kodama_cuda_%j.err

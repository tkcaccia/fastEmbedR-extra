...
#SBATCH --job-name="feR_kod_FlowRepository_FR-FC_cpu1"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/fastEmbedR_FlowRepository_FR-FCM-ZYRM_files_kodama_cpu1_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/fastEmbedR_FlowRepository_FR-FCM-ZYRM_files_kodama_cpu1_%j.err

...
#SBATCH --job-name="feR_land_imagenet_cuda"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/fastEmbedR_imagenet_landmark_cuda_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/fastEmbedR_imagenet_landmark_cuda_%j.err

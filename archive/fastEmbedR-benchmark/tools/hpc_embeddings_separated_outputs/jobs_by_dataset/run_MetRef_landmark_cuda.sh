...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/fastEmbedR_MetRef_landmark_cuda_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/fastEmbedR_MetRef_landmark_cuda_%j.err

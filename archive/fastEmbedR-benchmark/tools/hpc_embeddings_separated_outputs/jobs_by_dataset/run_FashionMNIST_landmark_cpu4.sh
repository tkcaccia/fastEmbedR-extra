...
#SBATCH --job-name="feR_land_FashionMNIST_cpu4"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/fastEmbedR_FashionMNIST_landmark_cpu4_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/fastEmbedR_FashionMNIST_landmark_cpu4_%j.err

...
#SBATCH --job-name="feR_land_Macosko2015_retina_cpu1"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/fastEmbedR_Macosko2015_retina_landmark_cpu1_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/fastEmbedR_Macosko2015_retina_landmark_cpu1_%j.err

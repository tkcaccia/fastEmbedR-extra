...
#SBATCH --job-name="feR_kod_MetRef_cuda"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/fastEmbedR_MetRef_kodama_cuda_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/fastEmbedR_MetRef_kodama_cuda_%j.err

...
#SBATCH --job-name="feR_land_Macosko2015_retina_cuda"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/fastEmbedR_Macosko2015_retina_landmark_cuda_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/fastEmbedR_Macosko2015_retina_landmark_cuda_%j.err

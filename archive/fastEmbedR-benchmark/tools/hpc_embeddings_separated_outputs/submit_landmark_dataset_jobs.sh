...
case "${PROFILE}" in
  all)  scripts=("${JOBS_DIR}"/run_*_landmark_*.sh) ;;
  cpu1) scripts=("${JOBS_DIR}"/run_*_landmark_cpu1.sh) ;;
  cpu4) scripts=("${JOBS_DIR}"/run_*_landmark_cpu4.sh) ;;
  cuda) scripts=("${JOBS_DIR}"/run_*_landmark_cuda.sh) ;;

...
#SBATCH --job-name=feR_clust_cpu1
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/feR_clust_cpu1_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/feR_clust_cpu1_%j.err
...
OUT_DIR="${OUT_DIR:-$BASE_DIR/fastEmbedR-results/clustering_validation/cpu1/$RUN_ID}"

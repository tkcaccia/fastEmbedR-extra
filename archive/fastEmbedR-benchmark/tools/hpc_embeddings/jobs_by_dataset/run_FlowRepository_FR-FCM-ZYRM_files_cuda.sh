...
#SBATCH --job-name="feR_FlowRepository_FR-FCM-ZYRM_f_cuda"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/fastEmbedR_review_FlowRepository_FR-FCM-ZYRM_files_cuda_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/fastEmbedR_review_FlowRepository_FR-FCM-ZYRM_files_cuda_%j.err

...
#SBATCH --job-name="feR_MNIST_cpu1"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/fastEmbedR_review_MNIST_cpu1_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/fastEmbedR_review_MNIST_cpu1_%j.err

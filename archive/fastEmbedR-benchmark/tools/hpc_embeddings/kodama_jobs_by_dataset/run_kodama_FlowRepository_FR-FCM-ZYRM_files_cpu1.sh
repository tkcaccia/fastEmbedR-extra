...
#SBATCH --job-name="feR_KODAMA_FlowRepository_FR-FC_cpu1"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/fastEmbedR_KODAMA_FlowRepository_FR-FCM-ZYRM_files_cpu1_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/fastEmbedR_KODAMA_FlowRepository_FR-FCM-ZYRM_files_cpu1_%j.err
...
export BENCHMARK_METHODS="KODAMA_plslda_opentsne_cpu,KODAMA_plslda_umap_cpu,KODAMA_knn_opentsne_cpu,KODAMA_knn_umap_cpu"

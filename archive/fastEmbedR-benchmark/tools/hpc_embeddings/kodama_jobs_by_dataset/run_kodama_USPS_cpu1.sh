...
#SBATCH --job-name="feR_KODAMA_USPS_cpu1"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/fastEmbedR_KODAMA_USPS_cpu1_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/fastEmbedR_KODAMA_USPS_cpu1_%j.err

...
#SBATCH --job-name="feR_KODAMA_TabulaMuris_cuda"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/fastEmbedR_KODAMA_TabulaMuris_cuda_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/fastEmbedR_KODAMA_TabulaMuris_cuda_%j.err

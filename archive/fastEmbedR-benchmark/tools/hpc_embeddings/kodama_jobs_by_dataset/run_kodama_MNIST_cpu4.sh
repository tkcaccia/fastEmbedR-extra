...
#SBATCH --job-name="feR_KODAMA_MNIST_cpu4"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/fastEmbedR_KODAMA_MNIST_cpu4_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/fastEmbedR_KODAMA_MNIST_cpu4_%j.err

set -euo pipefail

export BENCHMARK_DATASET="MNIST"

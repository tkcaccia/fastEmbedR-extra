...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/fastEmbedR_landmark_MNIST_cuda_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/fastEmbedR_landmark_MNIST_cuda_%j.err

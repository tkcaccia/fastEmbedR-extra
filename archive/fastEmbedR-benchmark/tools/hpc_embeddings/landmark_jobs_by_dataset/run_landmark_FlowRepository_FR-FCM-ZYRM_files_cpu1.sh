...
#SBATCH --job-name="feR_land_FlowRepository_FR-FCM-ZY_cpu1"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/fastEmbedR_landmark_FlowRepository_FR-FCM-ZYRM_files_cpu1_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/fastEmbedR_landmark_FlowRepository_FR-FCM-ZYRM_files_cpu1_%j.err
